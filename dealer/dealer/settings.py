...
Generated by 'djangocms' command using django CMS 5.1.0dev1 and Django 4.2.
...
https://docs.django-cms.org/en/release-5.1.x/reference/configuration.html
"""
...
SECRET_KEY = 'django-insecure-1@h%(6soa5j71v9p_yt#)*c9c85=s!2llz_%s)*qhe*h2ka4d6'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "dealer", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# https://docs.django-cms.org/en/release-5.1.x/how_to/multi-site.html

SITE_ID = 1

# A base template is part of this setup
# https://docs.django-cms.org/en/release-5.1.x/reference/configuration.html#cms-templates
...
# Enable permissions
# https://docs.django-cms.org/en/release-5.1.x/topics/permissions.html
